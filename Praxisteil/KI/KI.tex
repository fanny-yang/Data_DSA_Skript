...
Computer begegnen uns täglich im Alltag. Deren Rechenleistung wächst nach dem Mooreschen Gesetz exponentiell an und ermöglicht somit eine rapide Weiterentwicklung im Bereich der Künstlichen Intelligenz. Wird dadurch ermöglicht, dass Computer so intelligent wie Menschen werden? Wer übernimmt die Verantwortung, wenn es soweit kommt?
%

Zur Behandlung des Themas Künstliche Intelligenz (KI) geben wir zunächst einen Überblick über eine mögliche Definition und die verschiedenen Arten von KI.
Anschließend werden wir Anwendungsbereiche darstellen und uns mit der Frage beschäftigen, wer die Verantwortung übernimmt, sowie unsere eigene Einstellung zur KI darstellen.

Künstliche Intelligenz bezeichnet den Versuch, spezifische, menschliche Verhaltensweisen, vor allem die Intelligenz, maschinell nachzuahmen. Im besten Fall den Menschen in seinen Fähigkeiten zu übertreffen. Hierbei verbindet die KI computerwissenschaftliche und kognitionswissenschaftliche Forschung.
...
Grob gesagt bezeichnet „schwache KI“ Programme, welche für bestimmte Anwendungsdomänen entwickelt wurden. Ein Computer versucht, Intelligenz zu simulieren. Dies wird in unterschiedlichen Bereichen angewendet. Viele davon begegnen uns regelmäßig im Alltag. Zu den Teilgebieten gehören die Spracherkennung, die Verarbeitung natürlicher Sprachen, vor allem in Form vom Übersetzen, das Computersehen und die Robotik \cite{UniversitaetJena} \cite{Spektrum_1}.
Auf der anderen Seite steht die starke KI, welche zum Ziel hat, Computern intellektuelle Fähigkeiten, wie z.B. logisches Denken, Treffen von Entscheidungen bei Unsicherheit, Planen, Lernen und Kommunikation in natürlicher Sprache zu verleihen. Sie soll natürliche Kreativität und Emotionen nachbilden, gleichzeitig aber auch Bewusstsein bzw. Selbstbewusstsein ermöglichen. In diesem Zusammenhang stellt sich die Frage, wann man von einer gelungenen starken KI sprechen kann. Das zur Zeit am weitest verbreitete Kriterium für starke KI ist der Turing-Test.
%

Dieser Test stammt von Alan Turing, welcher ihn in seinem 1947 veröffentlichten Aufsatz „Intelligent Machinery“ erstmals erwähnt hat. Am Test sind zwei Menschen und eine Maschine beteiligt. In einem Raum befindet sich eine Person, die nur über Tastatur und Bildschirm entweder mit einer Maschine oder einem Menschen kommuniziert. Ziel ist es, durch geschicktes Fragen herauszufinden, ob der Gesprächspartner Mensch oder Maschine ist. Wenn der Mensch einen Computer als Menschen deklariert, so gilt die Versuchsperson als durch den Computer getäuscht und der Computer hat den Turing-Test bestanden.
%

Es besteht eine große Diskussion darüber, inwiefern dieser Test wirklich auf starke KI testet. Dafür spricht, dass in vielerlei Hinsicht eine menschliche Intelligenz getestet werden kann, da es in dem Test nicht nur um Wissen über die Welt, sondern vielmehr auch um soziale und emotionale Reaktionen bis hin zu religiösen Einstellungen geht. Ein weiterer positiver Punkt ist, dass dem Computer bei dem Test Flexibilität und Anpassungsfähigkeit abverlangt werden. Schließlich muss er sich mit dem plötzlichen Wechsel zwischen Themen im Gespräch auseinandersetzen oder auf einen in eine Unterhaltung über das Wetter eingestreuten Witz reagieren können.
%

Jedoch gab es seit Einführung des Tests Schwierigkeiten. Es ist nämlich relativ einfach möglich, Computerprogramme genauso zu programmieren, dass sie auf die meisten Fragen antworten können oder zumindest, wenn sie keine Antwort kennen,  dann mithilfe von Gegenfragen oder Ablenkungsmanövern zu reagieren \cite{NewAtlantis}.  Allerdings würden die meisten das noch nicht als intelligent bezeichnen.
...
1. die Fähigkeit abstrakt und vernünftig zu denken und daraus zweckvolles Handeln abzuleiten und
...
Ein weiteres Beispiel, auch von Google entwickelt, ist das Programm „Deep Dream“. Dieses Programm ist dazu fähig, bereits vorhandene Bilder zu verändern, sodass sie einen neuen Eindruck vermitteln bzw. bestimmte Stimmungen wiedergeben.  An dieser Stelle liegt die Frage nahe, inwiefern eine solche Software selbst als Künstler oder Schöpfer angesehen werden kann und damit auch intellektuelle Eigenschaften besitzt. Am Anfang von kreativer Schöpfung liegen Ideen, die ein Computer in dieser Form nicht haben kann (Anmerkung der Redaktion: von vielen KI Forschern wird jedoch die Meinung vertreten, dass Computer Ideen haben können, die denen von Menschen in nichts nachstehen). Dem Computer werden Daten vorgegeben, die er so verarbeitet, dass etwas Neues daraus entstehen kann. Es ist einer Software nicht möglich, eine neue Kunstepoche einzuleiten, wie es beispielsweise die Impressionisten getan haben.
...
Beispielsweise ist es Computern bereits möglich, Straftaten auf Videoaufnahmen zu erkennen. Dieses Programm kann sich sehr gut an verschiedene Situationen anpassen. Durch die intelligenten Maschinen kommt es zu einer Zeitersparnis für den Menschen, da die Maschine selbstständig 24 Stunden die Aufsicht übernimmt. Dadurch wird die Leistungsfähigkeit stark erhöht. Trotz der Vorteile, die sich ergeben, sollte man sich auch über die Nachteile bewusst werden. Dadurch, dass der Mensch den Maschinen wichtige Aufgaben überlässt, überträgt er einen Teil seiner Verantwortung auf den Computer. Es kann immer sein, dass ein Computer eine Straftat „übersieht“, da er diese noch nicht erlernt hat \cite{UniversitaetHamburg_1}. Es kommt zu einer Art von Kontrollverlust, da der Mensch dem Computer vertraut und nur stichprobenartige Tests zur Analyse des Programmes und dessen Fehlern durchführt. Dieses Programm kann somit von Straftätern manipuliert werden. Der Mensch sollte deshalb bei der Benutzung solche Programme, darauf achten, die damit einhergehenden Folgen nicht zu unterschätzen. Ist es nicht deshalb besser, Menschen teilweise diese Arbeit zu überlassen, auch unter Rücksichtnahme auf die vielen Arbeitsplätze, die durch die Programme der künstlichen Intelligenz wegfallen?
%
