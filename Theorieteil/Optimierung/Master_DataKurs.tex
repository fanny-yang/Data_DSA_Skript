...
\begin{coursetitle}
  ...
  \bigskip
 \includegraphics[width=.9\columnwidth]{\media Grafik-TempKursfoto.jpg}
 \label{fig:meinbild}
  \bigskip
\end{coursetitle}
%\begin{dsafigure}
...
%SECTION KOMMT NACHHER NOCH IN UNTERDATEI
\section{Optimierung}

\input{Inhalt-OptimierungLennart}
\input{Inhalt-OptimierungLukasL}
%\input{Inhalt-OptimierungPatrice}
