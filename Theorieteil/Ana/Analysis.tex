...
Es lässt sich leicht beweisen, dass eine Funktion $f:\mathbb{R} \rightarrow \mathbb{R}$, welche differenzierbar an der Stelle $x \in \mathbb{R}$ ist auch stetig an der Stelle $x \in \mathbb{R}$ ist.\\ %Satz ist noch nicht optimal formuliert
...
Diese Funktion wäre außerdem stetig an der Stelle $x$, wenn $\lim\limits_{w \rightarrow x} f(w)=f(x)$.\\
...
%Jetzt funktioniert sie, Bruch-Splitting nicht möglich, Aufteilung in einzelne Brüche #Lukas K
