...
\begin{enumerate}
	...
	\item $\mathds{P}$ bezeichnet die Sicherheit der Wahrscheinlichkeit, das Wahrscheinlichkeitsmaﬂ. Dieses weist jedem Ereignis in $\mathcal{F}$ eine reelle Zahl zu.  $\mathds{P}: \mathcal{F} \longrightarrow \mathds{R}$
...
\begin{enumerate}
	...
	\vspace{3pt}
	\begin{equation*}
	\mathds{P} (\bigcup_{i=1}^m \mathds{E}_{i}) = \sum_{i=1}^n \mathds{P} (\mathds{E}_{i})$ f\"ur alle $\mathds{E}_{1},...,\mathds{E}_{m} \in \mathcal{F}
	\end{equation*}
\end{enumerate}
\vspace{5pt}
...
\begin{equation*}
\mathds{E} [X] = \sum_{x \in \Omega} X (i)  \mathds{P} ({i}) = \sum_{x\in\mathcal{X}} X \mathds{P} (X=x) 
\end{equation*}
...
Die Varianz kennzeichnet die Ausdehnung einer Wahrscheinlichkeit. Die Varianz einer Zufallsvariable X lautet
...
\begin{enumerate}
	...
	\vspace{3pt}, dann sind E und F unabh\"angig. 

\item Wenn f\"ur die Zufallsvariablen 
\begin{equation*}
X_{1}: \Omega_{1} \longrightarrow \mathds{R} \: \text{ und } \: X_{2}: \Omega_{2} \longrightarrow \mathds{R}
\end{equation*}

\begin{equation*}
\text{ gilt } \: \mathds{P} (\{X_{1} \in A\} \cap \{X_{2} \in B\} ) = \mathds{P} (\{X_{1} \in A\}) \mathds{P}(\{X_{2} \in B\} )
\end{equation*}
\vspace{3pt}
...
\vspace{5pt}
\begin{equation*}
X_{1}:\Omega \longrightarrow \mathds{R} \: \text{ und } \: X_{2}:\Omega \longrightarrow \mathds{R}
\end{equation*}
\begin{equation*}
Y=X_{1}+X_{2}
\end{equation*}
