...
\begin{dsafigure}
	\begin{center}
		...
		\caption{Ein vollständig verbundenes neuronales Netzwerk mit $i$ Eingängen und $k$ Ausgängen, bestehend aus $n$ Schichten mit jeweils $m_n$ \enquote{Neuronen}, wobei $m_n$ für die Anzahl an Neuronen der n-ten Schicht steht.}
